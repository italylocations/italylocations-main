...
const en = {
  ...
  pages: {
    ...
    cars: {
      label: 'VINTAGE PORSCHE SPECIALISTS',
      h1: 'Vintage Porsche & Classic Cars<br>for Film Production',
      ...
      finalH2: 'Need a Specific Car?',
      finalCta: 'Get in Touch →',
      heroSubtitle:
        "Italy's specialist in air-cooled Porsches and iconic vehicles for film, advertising, editorial and music video productions across Italy",
      introParagraphs: [
      ...
      porscheLabel: 'PORSCHE SPECIALIST',
      porscheH2: 'The Right Porsche for Every Production',
      porscheDesc:
        'Our network gives us access to an extensive roster of vintage and classic Porsches across Italy — from air-cooled 911s to rare limited editions — available exclusively for film, advertising, editorial and music video productions. Our three resident Porsches are available immediately. Additional models sourced on request within 48 hours.',
      beyondH2: 'Beyond Porsche — Any Iconic Car, Sourced for You',
      beyondDesc:
        'Our network extends to Lamborghini, Ferrari, Alfa Romeo, Mercedes, Maserati and more. If you need a specific make, model or era — we find it.',
      whyLabel: 'WHY CHOOSE US',
      whyH2: 'Why Italy Locations',
      whyPoints: [
        { title: 'Porsche Network', desc: 'Extensive contacts across Italy give us access to the widest selection of vintage and classic Porsches available for production.' },
        { title: 'Production Ready', desc: 'Full documentation, insurance and permits handled by our team. Every vehicle arrives ready to shoot.' },
        { title: 'Any Location in Italy', desc: 'We bring the car to your set, anywhere in Italy. Logistics fully managed from our end.' },
      ],
...
const it: typeof en = {
  ...
  footer: {
    ...
    registerCta: 'Registra la tua location →',
    links: {
  ...
  pages: {
    ...
    cars: {
      label: 'SPECIALISTI IN PORSCHE VINTAGE',
      h1: 'Porsche Vintage & Classic Cars<br>per Produzioni Cinematografiche',
      ...
      finalH2: "Cerchi un'auto specifica?",
      finalCta: 'Contattaci →',
      heroSubtitle:
        'Specialisti italiani in Porsche raffreddate ad aria e veicoli iconici per film, pubblicità, editorial e videoclip in tutta Italia',
      introParagraphs: [
      ...
      porscheLabel: 'PORSCHE SPECIALIST',
      porscheH2: 'La Porsche giusta per ogni produzione',
      porscheDesc:
        "La nostra rete ci garantisce accesso a un ampio roster di Porsche vintage e classiche in tutta Italia — dalle 911 raffreddate ad aria alle edizioni rare — disponibili esclusivamente per produzioni cinematografiche, pubblicitarie, editoriali e videoclip. Le nostre tre Porsche residenti sono disponibili immediatamente. Modelli aggiuntivi reperiti su richiesta entro 48 ore.",
      beyondH2: 'Oltre la Porsche — Qualsiasi Auto Iconica, Reperita per Te',
      beyondDesc:
        "La nostra rete si estende a Lamborghini, Ferrari, Alfa Romeo, Mercedes, Maserati e altro. Se hai bisogno di una marca, un modello o un'epoca specifica — la troviamo noi.",
      whyLabel: 'PERCHÉ SCEGLIERCI',
      whyH2: 'Perché Italy Locations',
      whyPoints: [
        { title: 'Network Porsche', desc: 'Una rete capillare in tutta Italia ci garantisce accesso alla più ampia selezione di Porsche vintage e classiche disponibili per la produzione.' },
        { title: 'Pronto per la Produzione', desc: 'Documentazione completa, assicurazione e permessi gestiti dal nostro team. Ogni veicolo arriva pronto per le riprese.' },
        { title: 'In Tutta Italia', desc: "Portiamo l'auto sul tuo set, ovunque in Italia. La logistica è interamente gestita da noi." },
      ],
...
const es: typeof en = {
  ...
  footer: {
    ...
    registerCta: 'Registra tu locación →',
    links: {
  ...
  pages: {
    ...
    cars: {
      label: 'ESPECIALISTAS EN PORSCHE VINTAGE',
      h1: 'Porsche Vintage & Clásicos<br>para Producción Cinematográfica',
      ...
      finalH2: '¿Buscas un coche específico?',
      finalCta: 'Contáctanos →',
      heroSubtitle:
        'Especialistas en Porsches refrigerados por aire y vehículos icónicos para cine, publicidad, editorial y videoclips en toda Italia',
      introParagraphs: [
      ...
      porscheLabel: 'PORSCHE SPECIALIST',
      porscheH2: 'El Porsche adecuado para cada producción',
      porscheDesc:
        'Nuestra red nos da acceso a un amplio roster de Porsches vintage y clásicos en toda Italia — desde 911 refrigerados por aire hasta ediciones limitadas raras — disponibles exclusivamente para producciones cinematográficas, publicitarias, editoriales y videoclips. Nuestros tres Porsches residentes están disponibles de inmediato. Modelos adicionales conseguidos a petición en 48 horas.',
      beyondH2: 'Más allá del Porsche — Cualquier Clásico Icónico, Conseguido para Ti',
      beyondDesc:
        'Nuestra red se extiende a Lamborghini, Ferrari, Alfa Romeo, Mercedes, Maserati y más. Si necesitas una marca, modelo o época específica — la encontramos.',
      whyLabel: 'POR QUÉ ELEGIRNOS',
      whyH2: 'Por qué Italy Locations',
      whyPoints: [
        { title: 'Red Porsche', desc: 'Amplios contactos en toda Italia nos dan acceso a la mayor selección de Porsches vintage y clásicos disponibles para producción.' },
        { title: 'Listo para Producción', desc: 'Documentación completa, seguro y permisos gestionados por nuestro equipo. Cada vehículo llega listo para rodar.' },
        { title: 'Toda Italia', desc: 'Llevamos el coche a tu set, en cualquier lugar de Italia. La logística es gestionada completamente por nosotros.' },
      ],
