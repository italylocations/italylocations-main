...
const services = [
  ...
  },
  {
    number: '02',
    emoji: '📋',
    title: 'Filming Permits & Legal Compliance',
  ...
  },
  {
    number: '04',
    emoji: '👥',
    title: 'Local Crew Network Access',
  ...
  },
  {
    number: '06',
    emoji: '🏛️',
    title: 'Photography Studio Network',
  ...
  },
  {
    number: '08',
    emoji: '🏠',
    title: 'Property Scouting Services',
    ...
    <main className="min-h-screen">
      ...
      <section className="relative pt-36 pb-28 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <AnimateOnScroll>
            ...
            >
              Professional Location Scouting Services
            </h1>
            <p className="text-[rgba(255,255,255,0.65)] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              Complete production support from brief to wrap day. Expert scouts, local knowledge,
              seamless logistics across all of Italy.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24 flex flex-col gap-8">
        {services.map((service, i) => (
          <AnimateOnScroll key={service.number} delay={i < 3 ? i * 80 : 0}>
...
function ServiceCard({ service }: { service: ServiceData }) {
  return (
    <div className="relative group bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] backdrop-blur-sm rounded-2xl overflow-hidden transition-all duration-300 hover:border-[rgba(201,168,76,0.35)] hover:gold-border-glow p-8 md:p-10">
      ...
      {/* Body: description left + list right */}
