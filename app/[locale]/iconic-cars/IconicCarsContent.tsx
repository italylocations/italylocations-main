...
const WHY_ICONS: LucideIcon[] = [Users, ShieldCheck, MapPin]

type Car = (typeof porscheCars)[number] | (typeof otherCars)[number]

function CarCard({ car, p }: { car: Car; p: ReturnType<typeof useLanguage>['t']['pages']['cars'] }) {
  return (
    <div className="h-full rounded-2xl bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] hover:border-[rgba(201,168,76,0.35)] transition-all duration-300 overflow-hidden group">
      ...
      <div className="p-6">
        <div className="flex flex-wrap gap-2 mb-4">
          {car.productionType.split('·').map((tag) => (
            <span
              key={tag}
        ...
        <p className="text-[rgba(255,255,255,0.55)] text-sm leading-relaxed mb-5">{car.description}</p>
...
export function IconicCarsContent() {
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-start gap-4 p-6 rounded-2xl bg-[rgba(201,168,76,0.06)] border border-[rgba(201,168,76,0.35)]">
              ...
              <div>
                ...
                <p className="text-[rgba(255,255,255,0.55)] text-sm leading-relaxed">{p.bannerDesc}</p>
              </div>
            </div>
          </div>
        </AnimateOnScroll>
      ...
      {/* Porsche Specialist Section */}
      <section className="px-6 pb-24">
        <div className="max-w-6xl mx-auto">
          <AnimateOnScroll>
            <div className="text-center mb-12">
              <span className="inline-block text-xs font-semibold tracking-[0.25em] uppercase text-[#c9a84c] mb-5 px-4 py-1.5 rounded-full border border-[rgba(201,168,76,0.3)] bg-[rgba(201,168,76,0.06)]">
                {p.porscheLabel}
              </span>
              <h2
              ...
              <p className="text-[rgba(255,255,255,0.55)] text-base md:text-lg leading-relaxed max-w-3xl mx-auto border-l-2 border-[rgba(201,168,76,0.4)] pl-6 text-left">
                {p.porscheDesc}
              </p>
            </div>
          </AnimateOnScroll>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {porscheCars.map((car, i) => (
              <AnimateOnScroll key={car.id} delay={i * 80} className="h-full">
                <CarCard car={car} p={p} />
              </AnimateOnScroll>
            ))}
          </div>
      ...
      {/* Beyond Porsche Section */}
      <section className="px-6 pt-20 pb-24 border-t border-[rgba(255,255,255,0.05)]">
        <div className="max-w-6xl mx-auto">
          <AnimateOnScroll>
            <div className="text-center mb-12">
              <h2
              ...
              <p className="text-[rgba(255,255,255,0.55)] text-base leading-relaxed max-w-2xl mx-auto">
                {p.beyondDesc}
              </p>
            </div>
          </AnimateOnScroll>
              ...
              return (
                <AnimateOnScroll key={point.title} delay={i * 100}>
                  <div className="text-center p-8 rounded-2xl bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
                    ...
                    <p className="text-[rgba(255,255,255,0.50)] text-sm leading-relaxed">{point.desc}</p>
                  </div>
                </AnimateOnScroll>
              )
            })}
              ...
              return (
                <AnimateOnScroll key={step.title} delay={i * 100}>
                  <div className="text-center p-8 rounded-2xl bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)]">
                    ...
                    <p className="text-[rgba(255,255,255,0.50)] text-sm leading-relaxed">{step.description}</p>
                  </div>
                </AnimateOnScroll>
              )
            })}
      ...
      <section className="px-6 py-20 border-t border-[rgba(255,255,255,0.05)]">
        <AnimateOnScroll>
          <div className="max-w-2xl mx-auto text-center p-10 rounded-2xl bg-[rgba(255,255,255,0.03)] border border-[rgba(201,168,76,0.2)]">
            ...
            <p className="text-[rgba(255,255,255,0.55)] mb-8 leading-relaxed">{p.finalSubtitle}</p>
