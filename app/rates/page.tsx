...
const bookingSteps = [
  { n: '1', text: 'Contact us with your project details and desired locations' },
  { n: '2', text: 'We provide a custom quote based on your specific needs' },
  { n: '3', text: 'Expert scout assigned to your project' },
  { n: '4', text: 'Receive comprehensive scouting reports and visuals' },
]
      ...
      <section className="relative pt-36 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          <AnimateOnScroll>
            ...
            >
              Transparent Pricing for Professional Productions
            </h1>
            <p className="text-[rgba(255,255,255,0.65)] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              All-inclusive daily rates. No hidden fees. No surprise costs. Just expert scouting
              across all of Italy.
            </p>
          </AnimateOnScroll>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          {pricingCards.map((card, i) => (
            <AnimateOnScroll key={card.region} delay={i * 100}>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-20">
        ...
        <AnimateOnScroll delay={100}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            {/* Dashed connector line — visible only on lg */}
            <div
            ...
            {bookingSteps.map((step) => (
              <div key={step.n} className="flex flex-col items-center text-center gap-4 relative">
                {/* Number circle */}
                <div
                  className="w-14 h-14 rounded-full flex items-center justify-center shrink-0 border border-[rgba(201,168,76,0.4)] bg-[rgba(201,168,76,0.08)] z-10"
                >
                  <span
  ...
  return (
    ...
    >
      ...
      <div className="flex items-end gap-1 mb-6">
        ...
        <span className="text-[rgba(255,255,255,0.4)] text-base mb-1">{card.period}</span>
      </div>
      ...
      {/* Iconic locations */}
      <p className="text-[rgba(255,255,255,0.4)] text-xs mb-6 italic">
        {card.locations}
      </p>
