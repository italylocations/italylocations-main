...
const NAV_HREFS = ['locations', 'iconic-cars', 'services', 'rates', 'about', 'contact'] as const
type NavKey = typeof NAV_HREFS[number]

const NAV_KEYS: { key: keyof ReturnType<typeof useLanguage>['t']['nav']; href: string }[] = [
  { key: 'locations', href: '/locations' },
  { key: 'cars',      href: '/iconic-cars' },
    ...
    >
      ...
      >
        <ul className="px-6 py-4 flex flex-col gap-4">
          ...
          <li className="pt-2 border-t border-[rgba(255,255,255,0.06)] flex items-center gap-1">
            {LANGS.map((l, i) => (
              <span key={l} className="flex items-center">
