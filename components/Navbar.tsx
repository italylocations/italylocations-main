...
export function Navbar() {
  ...
  const NAV_KEYS: { key: keyof typeof t['nav']; href: string }[] = [
    { key: 'locations', href: `${prefix}/locations` },
    { key: 'cars',      href: `${prefix}/iconic-cars` },
    { key: 'services',  href: `${prefix}/services` },
    { key: 'rates',     href: `${prefix}/rates` },
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
        {/* Logo */}
        <Link href={lang === 'en' ? '/' : `/${lang}`} className="flex-shrink-0 overflow-visible">
          <Image
