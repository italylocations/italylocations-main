    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(to bottom, rgba(0,0,0,0.55) 0%, rgba(10,15,30,0.80) 100%)',
          }}
        />
      </div>

      {/* Radial glow accent on top of overlay */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 text-center animate-fade-up">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 flex-wrap">
          {[
            ...
            <div
              key={text}
              className="flex items-center gap-2 text-sm text-[rgba(255,255,255,0.65)]"
            >
              <span>{icon}</span>
              <span>{text}</span>
            </div>
