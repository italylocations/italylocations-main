...
type Tab = 'mytheresa' | 'hnb'

export function LatestWorkSection() {
  const [active, setActive] = useState<Tab>('mytheresa')
    ...
    <section className="py-24 px-4 relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <p className="text-xs tracking-[0.3em] text-[#c9a84c] uppercase mb-6">
            Latest Work
          </p>
        ...
        {/* Contenuto tab — transizione opacity */}
        <div className="transition-opacity duration-300">

          {/* ── TAB 1: Mytheresa Festive ── */}
          {active === 'mytheresa' && (
            <div>
